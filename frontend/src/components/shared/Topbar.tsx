              ...
              {notifications.map((item) => (
                <button
                  ...
                  className={`w-full text-left px-5 py-4 transition-colors hover:bg-slate-50 dark:hover:bg-white/[0.03] ${
                    !item.isRead ? "bg-blue-50/50 dark:bg-blue-500/4" : ""
                  }`}
                >
        ...
        {role !== "admin" && (
          <>
            ...
            >
              ...
              {unreadCount > 0 && (
                <span className="absolute -right-1 -top-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-rose-500 px-1 text-[9px] font-bold text-white ring-2 ring-white dark:ring-slate-950">
