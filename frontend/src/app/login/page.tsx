    ...
    <div className="min-h-screen flex items-center justify-center bg-[#080d1a] p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md bg-white/5 border-white/10 shadow-2xl rounded-[40px] overflow-hidden backdrop-blur-xl animate-in zoom-in-95 duration-500">
        <CardHeader className="pt-12 pb-8 text-center bg-linear-to-b from-white/[0.03] to-transparent">
          ...
          <CardTitle className="text-3xl font-black text-white tracking-tighter uppercase">Chào mừng trở lại</CardTitle>
          <p className="text-slate-500 text-sm mt-2">Học tiếp lộ trình của bạn ngay hôm nay</p>
        </CardHeader>

        <CardContent className="px-10">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Email của bạn</label>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                 ...
                 <Link href="#" className="text-[10px] font-bold text-blue-500 hover:underline">Quên mật khẩu?</Link>
              </div>
              <div className="relative">
            ...
            >
              {isSubmitting ? <Loader2 className="animate-spin mr-2" size={20} /> : 'Đăng nhập ngay'}
            </Button>
          </form>
        </CardContent>
