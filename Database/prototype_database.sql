...
CREATE NONCLUSTERED INDEX IX_UserWordProgress_UserID
ON dbo.UserWordProgress (UserID);
GO

CREATE NONCLUSTERED INDEX IX_UserWordProgress_WordID
ON dbo.UserWordProgress (WordID);
GO

CREATE NONCLUSTERED INDEX IX_UserWordProgress_UserID_NextReviewDate
ON dbo.UserWordProgress (UserID, NextReviewDate)
INCLUDE (WordID, MasteryLevel, MemoryStatus, RepetitionCount, EaseFactor);
GO

CREATE NONCLUSTERED INDEX IX_UserWordProgress_NextReviewDate
ON dbo.UserWordProgress (NextReviewDate)
INCLUDE (UserID, WordID, MemoryStatus);
GO

/* Questions indexes */
CREATE NONCLUSTERED INDEX IX_Questions_WordID
ON dbo.Questions (WordID);
GO

CREATE NONCLUSTERED INDEX IX_Questions_CreatedByUserID
ON dbo.Questions (CreatedByUserID);
GO

/* WordTopics indexes */
CREATE NONCLUSTERED INDEX IX_WordTopics_TopicID
ON dbo.WordTopics (TopicID);
GO

/* ExerciseAttempts indexes */
CREATE NONCLUSTERED INDEX IX_ExerciseAttempts_UserID_AttemptedAt
ON dbo.ExerciseAttempts (UserID, AttemptedAt DESC)
INCLUDE (QuestionID, WordID, IsCorrect, ScoreAwarded);
GO

CREATE NONCLUSTERED INDEX IX_ExerciseAttempts_WordID
ON dbo.ExerciseAttempts (WordID);
GO

CREATE NONCLUSTERED INDEX IX_ExerciseAttempts_QuestionID
ON dbo.ExerciseAttempts (QuestionID);
GO

/* ExampleSentences indexes */
CREATE NONCLUSTERED INDEX IX_ExampleSentences_WordID
ON dbo.ExampleSentences (WordID);
GO

/* Words indexes */
CREATE NONCLUSTERED INDEX IX_Words_PartOfSpeechID
ON dbo.Words (PartOfSpeechID);
GO

CREATE NONCLUSTERED INDEX IX_Words_CreatedByUserID
ON dbo.Words (CreatedByUserID);
GO

/* MiniTests / MiniTestItems indexes */
CREATE NONCLUSTERED INDEX IX_MiniTests_TopicID
ON dbo.MiniTests (TopicID);
GO

CREATE NONCLUSTERED INDEX IX_MiniTestItems_QuestionID
ON dbo.MiniTestItems (QuestionID);
GO
