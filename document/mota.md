...
## Mục lục
- [3.3.1. Các Use-cases dùng chung cho hệ thống](#331-các-use-cases-dùng-chung-cho-hệ-thống)
  - [UC 001: Đăng nhập hệ thống](#a-uc-001-đăng-nhập-hệ-thống)
  - [UC 002: Đăng ký tài khoản (Dành cho Học viên)](#b-uc-002-đăng-ký-tài-khoản-dành-cho-học-viên)
  - [UC 003: Cập nhật thông tin cá nhân](#c-uc-003-cập-nhật-thông-tin-cá-nhân)
  - [UC 004: Thay đổi mật khẩu](#d-uc-004-thay-đổi-mật-khẩu)
- [3.3.2. Các Use-cases dành cho Học viên (Learner)](#332-các-use-cases-dành-cho-học-viên-learner)
  - [UC 005: Xem Dashboard học tập cá nhân](#a-uc-005-xem-dashboard-học-tập-cá-nhân)
  - [UC 006: Học từ vựng mới theo chủ đề (Learn)](#b-uc-006-học-từ-vựng-mới-theo-chủ-đề-learn)
  - [UC 007: Luyện tập thông qua Flashcard Spaced Repetition (Practice)](#c-uc-007-luyện-tập-thông-qua-flashcard-spaced-repetition-practice)
  - [UC 008: Tự động cập nhật tiến trình học từ vựng](#d-uc-008-tự-động-cập-nhật-tiến-trình-học-từ-vựng-userwordprogress-thông-qua-sp)
  - [UC 009: Làm đề thi thử (Mini Test)](#e-uc-009-làm-đề-thi-thử-mini-test)
  - [UC 010: Xem lịch sử kiểm tra và đáp án chi tiết](#f-uc-010-xem-lịch-sử-kiểm-tra-và-đáp-án-chi-tiết)
  - [UC 011: Xem bảng thành tích học tập và Huy hiệu](#g-uc-011-xem-bảng-thành-tích-học-tập-và-huy-hiệu-achievements--gamification)
- [3.3.3. Các Use-cases dành cho Biên tập viên (Content Creator)](#333-các-use-cases-dành-cho-biên-tập-viên-content-creator)
  - [UC 012: Xem Dashboard & Báo cáo số liệu Content Creator](#a-uc-012-xem-dashboard--báo-cáo-số-liệu-content-creator)
  - [UC 013: Quản lý Chủ đề (Topics CRUD - Trạng thái Draft)](#b-uc-013-quản-lý-chủ-đề-topics-crud---trạng-thái-draft)
  - [UC 014: Quản lý Từ vựng & Câu ví dụ đi kèm](#c-uc-014-quản-lý-từ-vựng--câu-ví-dụ-đi-kèm-words--examples-crud---trạng-thái-draft)
  - [UC 015: Quản lý Câu hỏi ôn luyện](#d-uc-015-quản-lý-câu-hỏi-ôn-luyện-questions-crud---trạng-thái-draft)
  - [UC 016: Quản lý Đề kiểm tra ngắn (Mini Tests CRUD)](#e-uc-016-quản-lý-đề-kiểm-tra-ngắn-mini-tests-crud---trạng-thái-draft)
  - [UC 017: Quản lý Tệp đa phương tiện](#f-uc-017-quản-lý-tệp-đa-phương-tiện-upload--quản-lý-media-assets---hình-ảnhâm-thanh)
  - [UC 018: Gửi nội dung yêu cầu phê duyệt (Submit for Review)](#g-uc-018-gửi-nội dung-yêu-cầu-phê-duyệt-submit-for-review)
  - [UC 019: Xem danh sách nội dung theo trạng thái](#h-uc-019-xem-danh-sách-nội-dung-bản-nháp-drafts-đang-chờ-duyệt-pending-bị-từ-chối-kèm-lý-do-rejected)
- [3.3.4. Các Use-cases dành cho Quản trị viên (Admin)](#334-các-use-cases-dành-cho-quản-trị-viên-admin)
  - [UC 020: Xem Dashboard Analytics hệ thống](#a-uc-020-xem-dashboard-analytics-hệ-thống-thống-kê-toàn-cục)
  - [UC 021: Quản lý Danh mục chủ đề (Topic Categories CRUD)](#b-uc-021-quản-lý-danh-mục-chủ-đề-topic-categories-crud)
  - [UC 022: Duyệt và phê duyệt nội dung](#c-uc-022-duyệt-và-phê-duyệt-nội-dung-của-biên-tập-viên-approvereject-content)
  - [UC 023: Ghi nhận nhật ký lịch sử duyệt bài](#d-uc-023-ghi-nhận-nhật-ký-lịch-sử-duyệt-bài-contentreviewlogs)
  - [UC 024: Quản lý tài khoản Học viên](#e-uc-024-quản-lý-tài-khoản-học-viên-xem-danh-sách-khóamở-khóa-tài-khoản)
  - [UC 025: Xem báo cáo phân tích hiệu suất](#f-uc-025-xem-báo-cáo-phân-tích-hiệu-suất-word-distribution--daily-attempts-trends)
...
#### d. UC 023: Ghi nhận nhật ký lịch sử duyệt bài (ContentReviewLogs)
- **Mã Use case:** UC 023
...
#### e. UC 024: Quản lý tài khoản Học viên (Xem danh sách, Khóa/Mở khóa tài khoản)
- **Mã Use case:** UC 024
...
#### f. UC 025: Xem báo cáo phân tích hiệu suất (Word Distribution & Daily attempts trends)
- **Mã Use case:** UC 025
