// vocab-practice/backend/src/services/auth.service.js
...
class AuthService {
  static async register(fullName, email, password) {
    ...
    const result = await pool
      ...
      .input("Email", sql.NVarChar(255), email)
      .input("PasswordHash", sql.NVarChar(500), hashedPassword).query(`
  ...
  static async login(email, password) {
    ...
    const result = await pool
      .request()
      .input("Email", sql.NVarChar(255), email.toLowerCase().trim()).query(`
