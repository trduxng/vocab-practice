...
router.post('/content-review/:entityType/:entityId/approve', checkAnyPermission(['REVIEW_CONTENT', 'PUBLISH_CONTENT', 'MANAGE_SYSTEM_SETTINGS']), AdminController.approveContent);
router.post('/content-review/:entityType/:entityId/reject', checkAnyPermission(['REVIEW_CONTENT', 'PUBLISH_CONTENT', 'MANAGE_SYSTEM_SETTINGS']), AdminController.rejectContent);
router.post('/content-review/:entityType/:entityId/archive', checkAnyPermission(['REVIEW_CONTENT', 'PUBLISH_CONTENT', 'MANAGE_SYSTEM_SETTINGS']), AdminController.archiveContent);
router.get('/content-review/:entityType/:entityId/logs', checkAnyPermission(['REVIEW_CONTENT', 'PUBLISH_CONTENT', 'MANAGE_SYSTEM_SETTINGS']), AdminController.getContentReviewLogs);
